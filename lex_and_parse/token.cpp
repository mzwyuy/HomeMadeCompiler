...
std::unordered_map<string, KeyWord> TinyToken::token_to_keyword_= {
    ...
    {"str", KW_STR}, {"long", KW_LONG}, {"int", KW_INT}, {"char", KW_CHAR},
    {"bool", KW_BOOL}, {"void", KW_VOID},

    {"extern", KW_EXTERN}, {"if", KW_IF}, {"else", KW_ELSE}, {"switch", KW_SWITCH}, {"case", KW_CASE},
    {"default", KW_DEFAULT}, {"while", KW_WHILE}, {"do", KW_DO}, {"for", KW_FOR}, {"break", KW_BREAK},
    {"continue", KW_CONTINUE}, {"return", KW_RETURN},

    {"+", KW_ADD}, {"-", KW_SUB}, {"*", KW_MUL},
    {"/", KW_DIV}, {"%", KW_MOD}, {"++", KW_INC}, {"--", KW_DEC}, {"!", KW_NOT},
